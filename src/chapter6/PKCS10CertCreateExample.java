...
public class PKCS10CertCreateExample
{
        ...
        throws Exception
    {
        ...
        // fix: change parameter to an X500Principal object, passing the getEncoded() method of the CSR's getSubject() to X500Principal constructor
    ...
    {    
        ...
        final String FILENAME = "/home/erik/certificates/certchain.pem";
        
        FileOutputStream fos = new FileOutputStream(FILENAME);
        PEMWriter pemWrt = new PEMWriter(new OutputStreamWriter(fos));
        PEMWriter        pemWrtStdout = new PEMWriter(new OutputStreamWriter(System.out));
        
        pemWrt.writeObject(chain[0]);
        pemWrt.writeObject(chain[1]);
        pemWrt.close();
        
        System.out.println("Certificate chain written to file " + FILENAME);
        
        pemWrtStdout.writeObject(chain[0]);
        pemWrtStdout.writeObject(chain[1]);
        pemWrtStdout.close();
    }
}